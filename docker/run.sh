...
# ensemble
python /nnUNet/nnunet/inference/ensemble_predictions.py -t $THREADS -o $OUTPUTDIR -f 2d-fold0 2d-fold1 2d-fold2 2d-fold3 2d-fold4 3d_fullres-fold0 3d_fullres-fold1 3d_fullres-fold2 3d_fullres-fold3 3d_fullres-fold4 
