...
# 3d_lowres
OMP_NUM_THREADS=1 RESULTS_FOLDER=$MODELS_DIR python nnUNet/nnunet/inference/predict_simple.py -i /tmpdir -t $TASK_NAME -tr nnUNetTrainer --num_threads_preprocessing $THREADS --num_threads_nifti_save $THREADS -m 3d_lowres -f 0 -o 3d_lowres-fold0 -z
OMP_NUM_THREADS=1 RESULTS_FOLDER=$MODELS_DIR python nnUNet/nnunet/inference/predict_simple.py -i /tmpdir -t $TASK_NAME -tr nnUNetTrainer --num_threads_preprocessing $THREADS --num_threads_nifti_save $THREADS -m 3d_lowres -f 1 -o 3d_lowres-fold1 -z
OMP_NUM_THREADS=1 RESULTS_FOLDER=$MODELS_DIR python nnUNet/nnunet/inference/predict_simple.py -i /tmpdir -t $TASK_NAME -tr nnUNetTrainer --num_threads_preprocessing $THREADS --num_threads_nifti_save $THREADS -m 3d_lowres -f 2 -o 3d_lowres-fold2 -z
OMP_NUM_THREADS=1 RESULTS_FOLDER=$MODELS_DIR python nnUNet/nnunet/inference/predict_simple.py -i /tmpdir -t $TASK_NAME -tr nnUNetTrainer --num_threads_preprocessing $THREADS --num_threads_nifti_save $THREADS -m 3d_lowres -f 3 -o 3d_lowres-fold3 -z
OMP_NUM_THREADS=1 RESULTS_FOLDER=$MODELS_DIR python nnUNet/nnunet/inference/predict_simple.py -i /tmpdir -t $TASK_NAME -tr nnUNetTrainer --num_threads_preprocessing $THREADS --num_threads_nifti_save $THREADS -m 3d_lowres -f 4 -o 3d_lowres-fold4 -z
